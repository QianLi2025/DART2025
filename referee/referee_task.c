...
//#include "referee_UI.h"//绘制UI
#include "string.h"
//#include "rc_potocal.h"//读取遥控信号
#include "cmsis_os.h"
 ...
 * @attention
 */
 static void DeterminRobotID()//在referee_task.c中的void MyUIInit()使用，在图传上画UI用的
{
...
//    {
//        UILineDraw(&UI_shoot_line[0], "sl0", UI_Graph_Change, 8, 1 ? UI_Color_Pink : UI_Color_White, 3, 710, shoot_line_location[0], 1210, shoot_line_location[0]);
//        UILineDraw(&UI_shoot_line[1], "sl1", UI_Graph_Change, 8, 1 ? UI_Color_Pink : UI_Color_White, 3, shoot_line_location[1], 340, shoot_line_location[1], 740);
